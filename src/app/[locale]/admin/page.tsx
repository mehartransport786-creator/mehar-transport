      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
        ...
        <div className="xl:col-span-2 bg-white rounded-2xl border border-gray-100 p-6 md:p-8">
              ...
              <AreaChart data={stats.revenueChartData} margin={{ top: 5, right: 5, bottom: 5, left: 0 }}>
                <defs>
                  ...
                  <linearGradient id="previousGrad" x1="0" y1="0" x2="0" y2="1">
                    <stop offset="0%" stopColor="#df9a26" stopOpacity={0.1} />
                ...
                />
                <Area type="monotone" dataKey="previous" stroke="#df9a26" strokeWidth={2} fill="url(#previousGrad)" strokeDasharray="6 4" name={isAr ? "العام السابق" : "Previous Year"} />
          ...
          <div className="flex items-center gap-6 mt-4">
            ...
            <div className="flex items-center gap-2">
              <div className="w-3 h-0.5 rounded bg-secondary" style={{ borderTop: "2px dashed #df9a26", height: 0 }}></div>
