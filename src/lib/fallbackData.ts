export const fallbackVehicles = [
  ...
  { _id: 'v7', name: 'Luxury Bus', nameAr: 'حافلة فاخرة', type: 'Bus', typeAr: 'حافلة', passengers: 50, luggage: 40, image: '/fleet/luxury-bus.png', active: true, slug: 'luxury-bus' },
  { _id: 'v8', name: 'Mercedes S-Class', nameAr: 'مرسيدس إس كلاس', type: 'VIP', typeAr: 'كبار الشخصيات', passengers: 3, luggage: 3, image: '/fleet/s-class.png', active: true, slug: 'mercedes-s-class' },
  { _id: 'v9', name: 'Rolls-Royce', nameAr: 'رولز رويس', type: 'VIP', typeAr: 'كبار الشخصيات', passengers: 3, luggage: 2, image: '/fleet/rolls-royce.png', active: true, slug: 'rolls-royce' }
];
...
export const fallbackRoutesData = [
  ...
  { _id: 'r9', name: 'Makkah Ziyarat', nameAr: 'مزارات مكة', origin: 'Makkah Hotel', originAr: 'فندق مكة', destination: 'Ziyarat Tour', destinationAr: 'جولة مزارات', routeType: 'ziyarat', city: 'Makkah', distanceKm: 30, averageDurationMins: 180, slug: 'makkah-ziyarat', prices: [200, 250, 300, 350, 500, 600, 1200, 800, 2500] },
  { _id: 'r10', name: 'Madinah Ziyarat', nameAr: 'مزارات المدينة', origin: 'Madinah Hotel', originAr: 'فندق المدينة', destination: 'Ziyarat Tour', destinationAr: 'جولة مزارات', routeType: 'ziyarat', city: 'Madinah', distanceKm: 30, averageDurationMins: 180, slug: 'madinah-ziyarat', prices: [150, 200, 250, 300, 450, 500, 1100, 750, 2400] },
  { _id: 'r11', name: 'Makkah to Taif and Return', nameAr: 'مكة إلى الطائف والعودة', origin: 'Makkah', originAr: 'مكة', destination: 'Taif', destinationAr: 'الطائف', routeType: 'intercity', city: 'Taif', distanceKm: 180, averageDurationMins: 360, slug: 'makkah-to-taif-return', prices: [400, 500, 600, 700, 1000, 1200, 2500, 1500, 4000] },
  { _id: 'r12', name: 'Jeddah to Taif and Return', nameAr: 'جدة إلى الطائف والعودة', origin: 'Jeddah', originAr: 'جدة', destination: 'Taif', destinationAr: 'الطائف', routeType: 'intercity', city: 'Taif', distanceKm: 320, averageDurationMins: 480, slug: 'jeddah-to-taif-return', prices: [500, 600, 700, 800, 1200, 1500, 3000, 2000, 5000] },
