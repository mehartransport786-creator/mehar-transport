...
const vehiclesData = [
  ...
  { name: 'Luxury Bus', nameAr: 'حافلة فاخرة', type: 'Bus', typeAr: 'حافلة', passengers: 50, luggage: 40, image: '/fleet/luxury-bus.png', active: true, slug: 'luxury-bus' },
  { name: 'Mercedes S-Class', nameAr: 'مرسيدس إس كلاس', type: 'VIP', typeAr: 'كبار الشخصيات', passengers: 3, luggage: 3, image: '/fleet/s-class.png', active: true, slug: 'mercedes-s-class' },
  { name: 'Rolls-Royce', nameAr: 'رولز رويس', type: 'VIP', typeAr: 'كبار الشخصيات', passengers: 3, luggage: 2, image: '/fleet/rolls-royce.png', active: true, slug: 'rolls-royce' }
];

// 15 Routes
const routesData = [
  { name: 'Jeddah Airport to Makkah Hotel', nameAr: 'مطار جدة إلى فندق مكة', origin: 'Jeddah Airport', originAr: 'مطار جدة', destination: 'Makkah Hotel', destinationAr: 'فندق مكة', routeType: 'airport_transfer', city: 'Makkah', distanceKm: 85, averageDurationMins: 75, slug: 'jeddah-airport-to-makkah-hotel', prices: [200, 250, 300, 350, 500, 600, 1200, 800, 2500] },
  { name: 'Makkah Hotel to Jeddah Airport', nameAr: 'فندق مكة إلى مطار جدة', origin: 'Makkah Hotel', originAr: 'فندق مكة', destination: 'Jeddah Airport', destinationAr: 'مطار جدة', routeType: 'airport_transfer', city: 'Makkah', distanceKm: 85, averageDurationMins: 75, slug: 'makkah-hotel-to-jeddah-airport', prices: [150, 200, 250, 300, 450, 500, 1100, 750, 2400] },
