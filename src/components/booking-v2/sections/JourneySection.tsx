...
export function JourneySection() {
  ...
  return (
    <div className="bg-white rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-100 p-6 sm:p-8">
      ...
      {/* Service Type Toggle */}
      <div className="flex bg-[#F5F4F1] p-1.5 rounded-xl mb-8">
        <button
          ...
          className={`flex-1 flex items-center justify-center gap-2 py-3 rounded-lg font-semibold text-sm transition-all ${
            state.serviceType === "transfer" 
              ...
              : "text-gray-500 hover:text-[#1B1E4F]"
          }`}
        >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        {state.serviceType === "transfer" && (
          <div className="md:col-span-2 space-y-2">
            ...
            {routesLoading ? (
              <div className="flex items-center gap-2 text-gray-400 p-3 border border-gray-200 rounded-xl bg-gray-50">
              ...
              <div className="relative">
                ...
                <select
                  ...
                  className="w-full pl-11 pr-4 py-3.5 bg-gray-50 border border-gray-200 rounded-xl text-gray-800 font-medium focus:ring-2 focus:ring-[#D9A63A] focus:border-[#D9A63A] outline-none transition-all appearance-none"
                >
          ...
          <div className="md:col-span-2 space-y-2">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-11 pr-4 py-3.5 bg-gray-50 border border-gray-200 rounded-xl text-gray-800 font-medium focus:ring-2 focus:ring-[#D9A63A] focus:border-[#D9A63A] outline-none transition-all"
              />
            </div>
          </div>
        )}
