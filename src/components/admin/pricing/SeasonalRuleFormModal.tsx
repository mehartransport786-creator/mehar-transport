        ...
        <div className="px-8 py-6 space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="md:col-span-2">
              ...
              <select value={form.adjustmentType} onChange={e => updateField('adjustmentType', e.target.value)}
                className="w-full px-4 py-2.5 border border-gray-200 rounded-xl text-sm bg-white focus:border-[#D9A63A] outline-none">
          ...
          <div className="grid grid-cols-1 gap-4">
            <div className="flex items-center gap-2">
              <input type="checkbox" id="isActive" checked={form.isActive} onChange={e => updateField('isActive', e.target.checked)} className="w-4 h-4 text-[#1B1E4F] rounded border-gray-300" />
