    ...
    <section className="py-24 lg:py-32 bg-[#0a0a0a] text-white overflow-hidden relative">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-[1440px]">
        ...
        <div className="flex flex-col lg:flex-row gap-8 h-auto lg:h-[600px] relative z-10">
          ...
          {/* Main Display Image */}
          <div className="w-full lg:w-2/3 h-[400px] lg:h-full rounded-2xl overflow-hidden relative group">
              ...
              return (
                ...
                >
                  <div className="w-24 h-16 rounded-lg overflow-hidden shrink-0 relative">
                    ...
                    />
                    <div className={`absolute inset-0 transition-colors duration-300 ${isActive ? 'bg-black/0' : 'bg-black/40 group-hover:bg-black/20'}`}></div>
                  </div>
                  <div>
