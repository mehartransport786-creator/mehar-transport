...
All visual decisionsâ€”including color, typography, spacing, component styling, and interaction designâ€”must align with and support the logo rather than compete with it.
...
- **Secondary / Outline Button (`.btn-outline`):**
  ...
  - **Use Case:** Secondary actions (e.g., "Learn About Us", "View Details"). Often paired with a right arrow (`â†’`).
